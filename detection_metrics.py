...
labels = np.array([1-int(label) for label, score in data])
...
plt.show()
plt.savefig('/home/moonbo/aasist/exp_result/DF_AASIST_1mdfdc_ep50_bs64/metrics/roc_curve_detection_0.png')
